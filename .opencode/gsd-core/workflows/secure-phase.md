...
```
Agent(
  prompt="Read /home/atiyut/Documents/vispeech/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/atiyut/Documents/vispeech/.opencode/gsd-core/templates/SECURITY.md`
