...
- **Global scope**: `/home/atiyut/Documents/vispeech/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/atiyut/Documents/vispeech/.opencode/notes/`)
...
2. Glob `/home/atiyut/Documents/vispeech/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/atiyut/Documents/vispeech/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/atiyut/Documents/vispeech/.opencode/notes/` — works in any directory
