...
**Verification depth scales with `asvs_level`** (see @/home/atiyut/Documents/vispeech/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
